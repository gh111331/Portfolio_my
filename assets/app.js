...
const projectHref = (slug) => `/projects/${slug}/`;
  ...
  return `
    <header id="top" class="site-header">
      <div class="header-inner">
        <a class="wordmark" href="/" aria-label="Yuchen Huang, home">Y<span>H</span>.</a>
        <nav class="primary-nav" aria-label="Main navigation">
          <a href="/#projects" ${onHome ? 'aria-current="page"' : ""}>Projects</a>
          <a href="/cv/" ${onCv ? 'aria-current="page"' : ""}>CV</a>
      ...
      <section class="hero section-wrap" aria-labelledby="hero-title">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            ...
            <a class="button button-quiet" href="/cv/">View CV <span aria-hidden="true">↗</span></a>
          </div>
        </div>
...
function detailPage(project) {
  ...
  return `
    <main id="main" class="detail-page">
      ...
      <section class="more-projects section-wrap" aria-labelledby="more-projects-heading"><div class="section-heading compact"><div><p class="eyebrow">Keep exploring</p><h2 id="more-projects-heading">More projects<span class="period">.</span></h2></div><a class="text-link" href="/#projects">All work <span aria-hidden="true">↗</span></a></div><div class="more-project-list">${otherProjects.map((item) => `<a class="more-project-link" href="${projectHref(item.slug)}"><span><span class="eyebrow">${escapeHtml(item.kind)} · ${escapeHtml(item.year)}</span><strong>${escapeHtml(item.title)}</strong></span><span class="more-project-arrow" aria-hidden="true">↗</span></a>`).join("")}</div></section>
    </main>`;
}
  ...
  return `
    <main id="main" class="cv-page section-wrap">
      <section class="cv-intro" aria-labelledby="cv-heading">
        ...
        <div class="cv-heading-row"><h1 id="cv-heading">The CV<span class="period">.</span></h1><a class="button button-primary download-button" href="/assets/resume_Yuchen_H_AI.pdf" download="resume_Yuchen_H_AI.pdf">Download resume <span aria-hidden="true">↓</span></a></div>
      ...
      <section class="cv-section" aria-labelledby="experience-heading"><div class="cv-section-label"><p class="eyebrow">01</p><h2 id="experience-heading">Experience</h2></div><div class="cv-items">
        ...
        <article class="cv-item"><div class="cv-item-top"><div><h3>Game Designer &amp; Developer</h3><p class="cv-organization">Star Thief · Queen’s University</p></div><span class="cv-date">Jan 2024 – May 2025</span></div><ul><li>Collaborated with four teammates on a rhythm platformer controlled with a MIDI keyboard.</li><li>Integrated a MIDI input detection API with Unity for real-time input, rhythm detection, and gameplay.</li><li>Won Best Video Game at the 2025 Creative Computing Showcase.</li></ul><a class="text-link cv-project-link" href="/projects/star-thief/">View Star Thief <span aria-hidden="true">↗</span></a></article>
        ...
        <article class="cv-item"><div class="cv-item-top"><div><h3>Game Designer &amp; Developer</h3><p class="cv-organization">Serenity · Queen’s University</p></div><span class="cv-date">Jan 2023 – May 2023</span></div><ul><li>Collaborated with two teammates on an educational game featuring stress-management and relaxation activities.</li><li>Implemented gameplay and interactions using Unity and C#.</li><li>Nominated for Best Video Game at the 2023 Creative Computing Showcase.</li></ul><a class="text-link cv-project-link" href="/projects/serenity/">View Serenity <span aria-hidden="true">↗</span></a></article>
      </div></section>
      ...
      <div class="cv-bottom"><p>Want the one-page version?</p><a class="text-link" href="/assets/resume_Yuchen_H_AI.pdf" download="resume_Yuchen_H_AI.pdf">Download the resume <span aria-hidden="true">↓</span></a></div>
    </main>`;
}

function notFoundPage() {
  document.title = "Page not found — Yuchen Huang";
  return `<main id="main" class="not-found section-wrap"><p class="eyebrow">404 · Lost in the loop</p><h1>Page not found<span class="period">.</span></h1><p>That page isn’t here. Head back to the portfolio to find the projects and CV.</p><a class="button button-primary" href="/">Back to home <span aria-hidden="true">↗</span></a></main>`;
}
